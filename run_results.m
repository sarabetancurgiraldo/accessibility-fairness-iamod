...
% avgAcc
str_save = 'output/avgAcc.mat';
maxAverageAcc(nCar,Tmax,str_save,G,B,D,nArcs);

% pathAcc 
str_save = 'output/pathAcc.mat';
...
fp_save = 'output/path_flows_minTT.mat';
[minTT(1,1,1),minTT(1,1,2),minTT(1,1,3)] = path_flows_Leo(Tmax,X_matrix, ...
                                                          epsilonTT, ...
                                                          fp_save,D,B,G);
...
fp_save = 'output/path_flows_avgAcc.mat';
[avgAcc(1,1,1),avgAcc(1,1,2),avgAcc(1,1,3)] = path_flows_Leo(Tmax,X_matrix, ...
                                                             epsilonAvg, ...
                                                             fp_save,D,B,G);
...
fp_save = 'output/path_flows_pathAcc.mat';
[pathAcc(1,1,1),pathAcc(1,1,2),pathAcc(1,1,3)] = path_flows_Leo(Tmax,X_matrix, ...
                                                                epsilonPath', ...
                                                                fp_save,D,B,G);
...
fp_save = 'output/path_flows_pathAccMILP.mat';
[pathAccMILP(1,1,1),...
 pathAccMILP(1,1,2),...
...
fp_save = 'output/AFI_heatmap_minTT.mat';
...
fp_save = 'output/AFI_heatmap_avgAcc.mat';
...
fp_save = 'output/AFI_heatmap_pathAcc.mat';
